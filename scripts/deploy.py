...
def deploy():
	...
	solar = SolarBots.deploy(remainder, public_sale, '0xa6f5a10bfe034e9ca837611a33de415727b3b114a591226882443fd4f1f9cfae', {'from':user}, publish_source=True)
	mk = MkToken.deploy(solar, {'from':user}, publish_source=False)
	solar.updateYieldToken(mk, {'from':user})
	solar.updateUri("", {'from':user})